    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            for (int i = 0; i < numberOfTeams; i++)
            {
                ...
                if (isTeamNameFree == true && isCreatorNameFree == true || teams.Count == 0)
                {
                    teams.Add(currTeam);
                ...
                else if (isCreatorNameFree == false) Console.WriteLine($"{currTeam.TeamCreator} cannot create another team!");
            }
